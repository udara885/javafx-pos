...
public class ProductDetail implements SuperEntity{
    ...
    public ProductDetail(String code, String barcode, int qtyOnHand, double sellingPrice, double buyingPrice, double showPrice, int productCode, boolean discountAvailability) {
        this.code = code;
